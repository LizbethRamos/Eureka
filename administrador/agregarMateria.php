...
<body id="administrarM" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
                    ...
                    <div class="col-md-12 col-sm-12">
                         <form id="fomulario-form" role="form" method="post">
                              ...
                              <div class="section-title">
                                   <h2>Agregar materia<br><br><small>Completa los campos con la Información que se pide a continuación. </small></h2>
                              </div>
                              <table class="col-md-12">
                                   ...
                                   <tr>
                                        ...
                                        <td class="col-md-9 col-sm-12">
                                                  <input type="text" rows="2" class="form-control" NAME="url"">
                                        </td>
                                   </tr>
                              </table>
                              ...
                              <div class="col-md-4">
                              <br>
                                   <input type="submit" class="form-control" name="enviar" value="Agregar" onclick="return confirmarAccion('¿Seguro que desea agregar la materia?')">
                              </div>
    ...
    <?php
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $imagen = $_REQUEST['url'];
            $materias = mysqli_query($link, "select * from materias where materia = '$materia'");
            if($row=mysqli_fetch_array($materias)){
                echo "<script> alert('La materia $materia ya se encuentra en la base de datos');</script>";
            }else{
                $consulta = "insert into materias(materia,imagen) values('$materia','$imagen')";
