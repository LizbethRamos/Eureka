               ...
               <div class="row">
                    <div class="col-md-5">
                         <div id="informacion">
                              ...
                              <h4>Recuerda que al ser usuario de ésta plataforma puedes descargar tu exámen o mandarlo a tu correo, no dudes en aprovechar todos los beneficios que Eureka te ofrece. ¡ÉXITO!</h4>
                         </div>     
                    </div>
                    <div class="col-md-1"></div>
                    <div class="col-md-6">
                         <form role="form" action="contestarExamen.php" method="post">
                              <div class="col-md-12">
                                   <h2>Materias</h2>
