...
<body id="estadisticas" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                        <li><a href="inicioUsuario.php#inicioUsuario" class="smoothScroll">Inicio Usuario</a></li>
     ...
     <section>
          <div class="container">
               <div class="row">
					<h2>En ésta sección el Usuario puede ver las estadísticas del sistema y sus estadisticas personales sobre los diferentes temas y niveles en los que ha sido evaluado.</h2>
					<br>
                         <h3><A href='generar.pdf' target="_blank"> VER PDF </A></h3>
					<h3>La pantalla se muestra al Usuario.</h3>
					<h3>El Usuario puede ver las gráficas de los temas más solicitados.</h3>
					<h3>El Usuario puede ver la cantidad de pruebas generadas por el sistema.</h3>
					<h3>El Usuario puede ver los temas es los que mas ha fallado.</h3>
					<h3>El Usuario puede ver los resultados de las diferentes pruebas que ha realizado.</h3>
               </div>
          </div>
     </section>
